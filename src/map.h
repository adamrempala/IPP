 ...
 * Adam Rempała <ar406309@students.mimuw.edu.pl>
 ...
 */
typedef struct Map {
    Hash bindings; ///< wskaźnik na hashmapę
    Route routes[1000]; ///< tablica dróg krajowych (tablica 0 jest zawsze pusta)
} Map;
 ...
 * @param[in,out] map    – wskaźnik na strukturę przechowują char *start,cą mapę dróg;
 * @param[in] city1      – wskaźnik na napis reprezentujący nazwę miasta;
 * @param[in] city2      – wskaźnik na napis reprezentujący nazwę miasta;
